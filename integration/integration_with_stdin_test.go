...
func TestBuildWithStdin(t *testing.T) {
	...
	containerDiff(t, daemonPrefix+dockerImage, kanikoImageStdin, "--ignore-history", "--ignore-file-timestamps", "--ignore-file-mode", "--ignore-file-permissions", "--ignore-layer-length-mismatch")
