...
2. Use [`diffoci`](https://github.com/reproducible-containers/diffoci) to diff the images
...
* [`diffoci`](https://github.com/reproducible-containers/diffoci#installation)
